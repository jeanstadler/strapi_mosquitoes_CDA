      ...
      do {
        const response = await axios.get(`${TMDB_BASE_URL}/discover/movie`, {
          params: { // Paramètre des films qu'on va importer
            ...
            'primary_release_date.gte': '2025-08-01', // Filtre la date de sortie plus grande que...
            'primary_release_date.lte': '2025-11-30', // Filtre la date de sortie plus petite que...
